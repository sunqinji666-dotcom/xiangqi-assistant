...
[v1.2.0 をダウンロード](https://github.com/sunqinji666-dotcom/xiangqi-assistant/releases/latest) · [1分で始める](#1分で始める) · [仕組み](#1枚の画面から1手の提案へ) · [Star](https://github.com/sunqinji666-dotcom/xiangqi-assistant)

</div>

| 安定版 | 対応環境 | 実行方式 | ライセンス | 最終確認 |
|---|---|---|---|---|
| v1.2.0 · Build 3 | macOS 14+ · Apple Silicon | メニューバー · ローカル処理 | MIT、第三者例外あり | 2026-07-23 |
...
1. [Releases](https://github.com/sunqinji666-dotcom/xiangqi-assistant/releases/latest) から `XiangqiAssistant-v1.2.0-macOS-arm64.zip` をダウンロードします。
