...
[下载 v1.3.0](https://github.com/sunqinji666-dotcom/xiangqi-assistant/releases/latest) · [一分钟上手](#一分钟上手) · [查看工作原理](#从一帧画面到一手建议) · [Star / 收藏](https://github.com/sunqinji666-dotcom/xiangqi-assistant)

</div>

| 当前稳定版 | 支持平台 | 运行方式 | 许可证 | 最后验证 |
|---|---|---|---|---|
| v1.3.0 · Build 4 | macOS 14+ · Apple Silicon | 菜单栏 · 本地运行 | MIT；第三方组件除外 | 2026-07-22 |
...
1. 在 [Releases](https://github.com/sunqinji666-dotcom/xiangqi-assistant/releases/latest) 下载 `XiangqiAssistant-v1.3.0-macOS-arm64.zip`。
