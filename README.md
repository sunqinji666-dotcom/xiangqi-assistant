...
macOS 菜单栏里的中国象棋分析工具：选择棋盘窗口，识别局面，由本机 Pikafish 给出着法；可选的千问建议从本地候选中选择并补充思路。

**简体中文** · [English](docs/README.en.md) · [日本語](docs/README.ja.md)

[下载 v1.3.2](https://github.com/sunqinji666-dotcom/xiangqi-assistant/releases/latest) · [快速开始](#快速开始) · [Star / 收藏](https://github.com/sunqinji666-dotcom/xiangqi-assistant)

</div>

| 当前版本 | 支持平台 | 许可证 |
|---|---|---|
| v1.3.2 · Build 6 | macOS 14+ · Apple Silicon | MIT（第三方组件除外） |
...
- 可选千问建议：从本机筛出的候选着法中选择，并补充一条清晰的实战计划。
...
| 用 Pikafish 给出主线和评分。 | 在本机候选中选择一招，并给出简短理由与计划。 |
